...
export class SearchService implements ISearchService {
  ...
  public async searchUsers(): Promise<PageCollection<ExtendedUser>> {
    ...
    // switching to a group as no other way to accurately filter actual users
    // https://graph.microsoft.com/v1.0/groups/9faee22e-1638-4b00-9aa0-01367526d609/members
    let resultQuery = graphClient
      .api('/groups/9faee22e-1638-4b00-9aa0-01367526d609/members')
      .version("v1.0")
